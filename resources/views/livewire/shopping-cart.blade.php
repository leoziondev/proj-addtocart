<div class="flex justify-center my-6">
    <div class="flex flex-col w-full xl:max-w-7xl p-8 text-gray-800 bg-white shadow-lg pin-r pin-y mx-8 xl:mx-0">
        <div class="flex-1">
            ...
            <div class="my-4 mt-6 -mx-2 lg:flex">
                <div class="lg:px-2 lg:w-1/2 mb-4 lg:mb-0">
                    <label for="">Discount</label>
                    <input
                        wire:model.debounce.500ms="discount"
                        type="text"
                        class="w-full lg:w-1/3 rounded-md border-gray-300 block"
                    />
                </div>
